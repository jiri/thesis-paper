...
Komunikaci mezi aplikací a emulátorem zajišťuje třída \texttt{McuState}, využívající navrhový vzor Singleton\todo{cite}. Kromě udržování instance emulátoru vystavuje ještě několik signálů a slotů\todo{ref} pro knihovnu Qt a udržuje ostatní data potřebná ke správnému běhu aplikace.
