...
Ideální formou pro překladač je konzolová aplikace, aby formou následoval věštinu ostatních jazykových překladačů, jako je GCC \todo{Citation} nebo Clang \todo{Citation}. Aplikace bude primárně řešit následující problémy:
...
Základním stavebním blokem programu je struktura \texttt{Compiler} popsaná v ukázce \todo{REF}. 

\todoimage{code sample}
